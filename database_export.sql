...
CREATE TABLE `Delivery` (
  ...
  `Contact_info` varchar(255) NOT NULL,
  `Status` enum('Pending','To be Delivered','In Progress','Delivered') NOT NULL,
...
INSERT INTO `Orders` VALUES (1,'2025-02-22','Towel',51,'Dry Cleaning','Naawan','1','Pending',1,NULL),(2,'2025-02-22','Beddings',51,'Spot Cleaning','Hotel','2','Pending',1,NULL),(3,'2025-02-22','Table Cloth',51,'Wet Cleaning','Naawan','3','Pending',1,NULL),(4,'2025-02-22','Curtains',51,'Spot Cleaning','Naawan','2','To be Delivered',1,NULL),(5,'2025-02-22','Curtains',51,'Wet Cleaning','Naawan','2','To be Delivered',NULL,1);
...
-- Dump completed on 2025-02-25  8:59:52
